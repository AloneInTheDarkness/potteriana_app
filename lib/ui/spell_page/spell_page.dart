...
class SpellPage extends StatelessWidget implements AutoRouteWrapper {
  ...
  final CachedNetworkImage? passedSpellImage;

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SpellBloc, SpellState>(builder: (context, state) {
      if (state.isLoading) {
        return Stack(
          children: [
            Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: passedSpellImage ?? Image.asset('assets/images/question_mark.png'),
                    ),
                  ),
                ],
              ),
              ...
              child: ListView(
                children: [
                  ...
                  if (state.spell.incantation != null)
                    _buildFancySummary(
                        categoryTitle: "Incantation: ", content: state.spell.incantation!),
